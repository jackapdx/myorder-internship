...
เริ่มแรกของการพัฒนาระบบ ทีมงานได้ใช้แพลตฟอร์ม Miro เป็นศูนย์กลางในการออกแบบโครงสร้างทั้งหมด (Living Document) โดยมีการวาด Use Cases, โฟลว์การทำงาน (User Flow), Wireframes และการออกแบบโครงสร้างฐานข้อมูล (Entity-Relationship Diagram) ร่วมกัน
